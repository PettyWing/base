...
public class SelectDialog extends Dialog implements OnClickListener, OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.dialog_select,
                null);
    ...
    private void initViews() {
        ...
        mMBtnCancel = (Button) findViewById(R.id.mBtn_Cancel);
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (null == convertView) {
                ...
                convertView = layoutInflater.inflate(R.layout.dialog_select_item, null);
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = context.getResources().getColor(R.color.black);
                mOtherItemColor = context.getResources().getColor(R.color.black);
            }
            if (1 == mStrings.size()) {
                ...
                viewholder.dialogItemButton.setTextColor(mFirstItemColor);
                viewholder.dialogItemButton.setBackgroundResource(R.drawable.sel_dialog_item_bg_top);
            } else if (position == mStrings.size() - 1) {
                viewholder.dialogItemButton.setTextColor(mOtherItemColor);
                viewholder.dialogItemButton.setBackgroundResource(R.drawable.sel_dialog_item_bg_buttom);
            } else {
                viewholder.dialogItemButton.setTextColor(mOtherItemColor);
                viewholder.dialogItemButton.setBackgroundResource(R.drawable.sel_dialog_item_bg_center);
            }
            return convertView;
        }
